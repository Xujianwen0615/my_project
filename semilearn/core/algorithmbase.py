...
class AlgorithmBase:
    ...
    def __init__(
        ...
        **kwargs):
        ...
        # build supervised loss and unsupervised loss: Add by Bo Cheng
    ...
    def set_dataset(self):
        ...
        print("Labeled data length:", len(dataset_dict["train_lb"]))
        print("Unlabeled data length:", len(dataset_dict["train_ulb"]))
    ...
    def set_data_loader(self):
        ...
        # Added by Bo Cheng
        if 'warm_up_eval' in self.dataset_dict and self.dataset_dict['warm_up_eval'] is not None:
            loader_dict["warm_up_eval"] = get_data_loader(self.args,
                                                          self.dataset_dict["train_ulb"],
                                                          self.args.eval_batch_size,
                                                          # make sure data_sampler is None for evaluation
                                                          data_sampler=None,
